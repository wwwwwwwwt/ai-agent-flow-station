...
public class AiAgentTest {
    ...
    public void init() {
        ...
        OpenAiApi openAiApi = OpenAiApi.builder()
                ...
                .apiKey("sk-ncKhVyyDakF45qhi2827077230Fb4602AcE1Cb238c335055")
        ...
        chatModel = OpenAiChatModel.builder()
                ...
                .defaultOptions(OpenAiChatOptions.builder()
                        .model("gpt-4o")
                        .toolCallbacks(new SyncMcpToolCallbackProvider().getToolCallbacks())
                        .build())
                .build();
...
//                .defaultToolCallbacks(new SyncMcpToolCallbackProvider(stdioMcpClient(), sseMcpClient01(), sseMcpClient02()).getToolCallbacks())
                .defaultAdvisors(
                        ...
                        new RagAnswerAdvisor(vectorStore, SearchRequest.builder()
                                .topK(5)
                                .filterExpression("knowledge == 'wangdagua'")
                                .build()),
